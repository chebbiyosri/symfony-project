...
use Reformes\ActionsBundle\Entity\Blog;
...
class BlogController extends Controller
{
    ...
    {
        $blog = new Blog();
        $form = $this->createForm('Reformes\ActionsBundle\Form\BlogType', $blog);
        $form->handleRequest($request);

        if ($form->isSubmitted() && $form->isValid()) {
            $em = $this->getDoctrine()->getManager();
            $blog->setDateCreate(new \DateTime());
            $em->persist($blog);
            $em->flush();
    ...
    {
        $deleteForm = $this->createDeleteForm($blog);
        $editForm = $this->createForm('Reformes\ActionsBundle\Form\BlogType', $blog);
