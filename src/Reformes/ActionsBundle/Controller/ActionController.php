...
use Reformes\ActionsBundle\Entity\Action;
...
class ActionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $actions = $em->getRepository('ReformesActionsBundle:Action')->findAll();
    ...
    {
        $action = new Action();
        $form = $this->createForm('Reformes\ActionsBundle\Form\ActionType', $action);
    ...
    {
        $deleteForm = $this->createDeleteForm($action);
        $editForm = $this->createForm('Reformes\ActionsBundle\Form\ActionType', $action);
